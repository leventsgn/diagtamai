...
[data-theme="dark"] {
  ...
  --edge-color: #818cf8;
  /* Vibrant Indigo */
  --edge-glow: rgba(129, 140, 248, 0.4);
  --glass-border: rgba(255, 255, 255, 0.1);
  --node-shadow: 0 10px 15px -3px rgb(0 0 0 / 0.5), 0 4px 6px -4px rgb(0 0 0 / 0.5);
  --accent: #818cf8;
}
...
.sidebar> :not(.sidebar-header):first-of-type {
  padding-top: 12px;
}
...
.collapsible-content label:first-child {
  margin-top: 0;
}
...
/* Handle'ları varsayılan olarak gizle, hover/connect sırasında göster */
.react-flow__handle {
  opacity: 0;
...
/* Connection line'ı daha belirgin yap */
...
/* Edge label'ları daha okunabilir yap */
...
.node-2 { top: 130px; left: 50%; transform: translateX(-50%); }
...
@media (max-width: 768px) {
  ...
  .landing-features, .landing-how { padding: 60px 20px; }
  .section-title { font-size: 28px; }
  .hero-diagram-preview { width: 300px; height: 220px; }
